...
import JobGroupGrid from "../../components/Candidate/JobGroupGrid";
...
const Jobs = () => {
    ...
    return (
        <div className="container">
            ...
            <div class="modal fade" id="jobdepartmentmodal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Select Job Group and Department</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary" data-bs-target="#jobmodal" data-bs-toggle="modal">Back</button>
                        </div>
                    </div>
                </div>
            </div>
