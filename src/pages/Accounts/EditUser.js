...
function EditUser() {
  ...
  const handleEditUser = () => {
    ...
    axios.put(`/accounts/users/update/${id}/`, formDataToSend,{
      headers:{
  ...
  return (
    ...
    <div className="row align-items-center">
      ...
      <div className='col-md-3 d-flex justify-content-end mt-4'>
            ...
            <button class="btn btn-primary" onClick={handleEditUser}><i className="fas fa-pen"> </i> Update User</button>
      </div>
    </div>
          ...
          <h5 className="card-header">User Information</h5>
            <div className="card-body">
              ...
              <div className="col-md-6">
                  ...
                  <input type="text" className="form-control" id="first_name" value={userData.first_name}
                  onChange={(e) => setUserData({ ...userData, first_name: e.target.value })} />
                </div>
                <div className="col-md-6">
                  <label htmlFor="last_name" className="form-label">Last Name</label>
                  <input type="text" className="form-control" id="last_name" value={userData.last_name}
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input type="tel" className="form-control" id="phone_number" value={userData.phone_number}
                ...
                <div className="row g-3">
                  <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="emp_id" value={userData.emp_id}/>
                  </div>
                  <div className="col-md-3">
  <div className="form-check form-switch mt-4">
  <input className="form-check-input" type="checkbox" role="switch" id="is_active" checked={userData.is_active}
  ...
  <input className="form-check-input" type="checkbox" role="switch" id="is_superuser" checked={userData.is_superuser}
        onChange={(e) => {
...
<div className='col-md-3'>
<div className="form-check form-switch mt-4">
  <input className="form-check-input" type="checkbox" role="switch" id="is_staff" checked={userData.is_staff}
                    ...
                    <div className="col-md-3"> 
                      {/* <input type="file" className="form-control" id="user_image" accept="image/*"
                           onChange={handleImageChange}  /> */}
                            ...
                            {clearImage ? null : (
<>
            <label htmlFor="user_image" className="form-label" >{ImageLabel}</label><br/>            
            <img
              src={ currentImage}
              alt="User Preview"
            ...
            /><br/>
             ...
             <input className="form-check-input ml-0" type="checkbox" value="" id="flexCheckDefault" onChange={handleClearImage} />
