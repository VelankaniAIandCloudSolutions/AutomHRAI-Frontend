...
function CreateUser() {
  ...
  const handleCreateUser = () => {
    ...
    axios
      .post("/accounts/users/create/", formDataToSend, {
        headers: {
                        ...
                        <div className="col-md-2 ml-3">
                              ...
                              onChange={(e) => {
                                ...
                                setFormData({
                                  ...
                                  is_staff: is_superuser
                                    ? true
                                    : formData.is_staff, // Set is_staff to true if is_superuser is checked
                                });
                              }}
                            />
                            <label
                          ...
                          <div className="form-check form-switch ">
                            <input
                              ...
                              checked={formData.is_supervisor_admin}
                              onChange={(e) => {
                                ...
                                setFormData({
                                  ...
                                  is_supervisor: is_supervisor_admin
                                    ? true
                                    : formData.is_supervisor, // Set is_staff to true if is_supervisor is checked
                                });
                              }}
                            />
                            <label
