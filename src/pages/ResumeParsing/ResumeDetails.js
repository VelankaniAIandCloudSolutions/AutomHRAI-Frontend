...
const GridComponent = ({ joblist }) => {
  ...
  const DeleteButtonRenderer = (props) => {
    return (
      <button
        ...
        data-bs-toggle="modal" data-bs-target="#resumedeletemodal"
  ...
  const handleFormSubmit = async (formData) => {
    ...
    try {
      const response = await axios.put(`resume-parser/update_resume/${formData.id}/`, {
      ...
      cellRenderer: (params) => (
        <div style={{ marginLeft: "55px" }}>
          <a
            ...
            data-bs-toggle="modal" data-bs-target="#resumeeditmodal"
      ...
      >
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <ResumeEditForm editedRow={editedRow} onFormSubmit={handleFormSubmit} />
            </div>
